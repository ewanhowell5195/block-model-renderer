...
| **before 26.2** | Beds and signs render through bundled override models (the versioned `overrides_26.1` pack activates) | They were block entities without models until 26.2 made them data-driven |
