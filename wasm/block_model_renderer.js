/* @ts-self-types="./block_model_renderer.d.ts" */

export class Emitted {
    static __wrap(ptr) {
        const obj = Object.create(Emitted.prototype);
        obj.__wbg_ptr = ptr;
        EmittedFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        EmittedFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_emitted_free(ptr, 0);
    }
    /**
     * @param {number} i
     * @returns {Uint8Array}
     */
    color(i) {
        const ret = wasm.emitted_color(this.__wbg_ptr, i);
     ...
     */
    get count() {
        const ret = wasm.emitted_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} i
     ...
     */
    faceData(i) {
        const ret = wasm.emitted_faceData(this.__wbg_ptr, i);
     ...
     */
    normal(i) {
        const ret = wasm.emitted_normal(this.__wbg_ptr, i);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    position(i) {
        const ret = wasm.emitted_position(this.__wbg_ptr, i);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    uv(i) {
        const ret = wasm.emitted_uv(this.__wbg_ptr, i);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
 ...
 * @param {number} acc_count
 * @returns {Emitted}
 */
export function emitQuads(quads, faces, acc_count) {
    const ptr0 = passArrayF64ToWasm0(quads, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(faces, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.emitQuads(ptr0, len0, ptr1, len1, acc_count);
    return Emitted.__wrap(ret);
}

/**
 * `triples` is `[grid, a, b, ...]`, the result is `[grid, a0, a1, b0, b1, ...]`.
 * @param {Int32Array} triples
 * @param {number} grid_count
 * @returns {Int32Array}
 */
export function greedyMesh(triples, grid_count) {
    const ptr0 = passArray32ToWasm0(triples, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.greedyMesh(ptr0, len0, grid_count);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./block_model_renderer_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('block_model_renderer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
